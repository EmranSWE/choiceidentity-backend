...
router.get('/overview/core', (0, auth_1.default)(user_1.ENUM_USER_ROLE.AFFILIATE), affiliate_controller_1.AffiliateController.getOverview);
...
router.get('/analytics/links/', (0, auth_1.default)(user_1.ENUM_USER_ROLE.AFFILIATE), affiliate_controller_1.AffiliateController.listLinks);
