...
exports.validateProductData = exports.GetTrendingProducts = exports.vimeoRegex = exports.youtubeRegex = void 0;
...
const validateProductData = (productData) => {
    if (!productData.basicInfo) {
        throw new apiErrors_1.default(http_status_1.default.BAD_REQUEST, 'Basic product information is required');
    }
    if (productData.pricing.salePrice > productData.pricing.defaultPrice) {
        throw new apiErrors_1.default(http_status_1.default.BAD_REQUEST, 'Sale price cannot be higher than default price');
    }
    if (productData.inventory.curStock < 0) {
        throw new apiErrors_1.default(http_status_1.default.BAD_REQUEST, 'Stock quantity cannot be negative');
    }
};
